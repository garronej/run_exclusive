...
var MyClass = /** @class */ (function () {
    function MyClass() {
        var _this = this;
        this.alphabet = "";
        this.myMethod = runExclusive.buildMethod(MyClass.groupRef, function (char, wait) { return __awaiter(_this, void 0, void 0, function () {
...
inst1.myMethod.call(MyClass, "a", 1000).then(function (alphabet) { return console.log(alphabet); });
inst1.myMethod.call(MyClass, "b", 1000).then(function (alphabet) { return console.log(alphabet); });
var inst2 = new MyClass();
var rev = ["n", "m", "l", "k", "j", "i", "h", "g", "f", "e", "d", "c", "b"];
var wait = 500;
for (var _i = 0, rev_1 = rev; _i < rev_1.length; _i++) {
    var char = rev_1[_i];
    inst2.myMethod.call(MyClass, char, wait).then(function (alphabet) { return console.log(alphabet); });
}
...
inst1.myMethod.call(MyClass, "c", 1000).then(function (alphabet) { return console.log(alphabet); });
inst1.myMethod.call(MyClass, "d", 1000).then(function () {
