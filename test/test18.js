...
var alphabet = "";
var myFunction = runExclusive.build(function (char) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                myFunction("a");
                myFunction("b");
                runExclusive.getPrComplete(myFunction).then(function () {
                    console.assert(alphabet === "ab");
                });
                return [4 /*yield*/, myFunction("c")];
            case 1:
                _a.sent();
