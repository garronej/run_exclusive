...
var MyClass = /** @class */ (function () {
    function MyClass() {
        var _this = this;
        this.alphabet = "";
        this.myMethod = runExclusive.buildMethod(function (char) { return __awaiter(_this, void 0, void 0, function () {
...
var MyClassProxy = /** @class */ (function () {
    function MyClassProxy() {
        ...
        this.evtCreate = evt_1.Evt.create();
        this.myMethod = runExclusive.buildMethod(function () {
            var inputs = [];
            ...
            return new Promise(function callee(resolve, reject) {
                if (!self.myClassInst) {
                    self.evtCreate.attachOnce(function () { return callee(resolve, reject); });
                    return;
                }
